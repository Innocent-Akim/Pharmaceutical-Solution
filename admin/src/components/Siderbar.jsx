...
function Siderbar() {
  ...
  const styleCount =
    "flex p-4 h-10 mx-2 my-2 font-normal items-center rounded cursor-pointer gap-3 bg-white hover:border-b-4 hover:border-blue-900 text-blue-900 ease-in duration-300";
  return (
    <div className="flex-shrink-0 z-10 h-screen  sidebar-inner-wrapper hidden w-64 bg-white shadow-sm dark:border-primary-darker dark:bg-darker md:block">
